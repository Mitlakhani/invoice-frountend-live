...
const CustomerView = () => {
  ...
  useEffect(() => {
    const fetchCustomer = async () => {
      try {
        const response = await axios.get(
          `https://invoich-backend.onrender.com/api/customer/viewCustomers/${id}`
        );
    ...
    const fetchInvoices = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend.onrender.com/api/invoice/viewAll",
          {
    ...
    const fetchCreditNotes = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend.onrender.com/api/creditNotes/viewall",
          {
            headers: {
