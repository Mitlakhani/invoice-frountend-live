...
const ManageSalespersonsPopup = ({ onClose }) => {
    ...
    const fetchSalespersons = async () => {
      try {
        const response = await fetch(
          "https://invoich-backend.onrender.com/api/salespersons/getallsalespersone"
        );
        if (!response.ok) {
  ...
  const handleSave = async () => {
    ...
    if (name && email) {
      ...
      try {
        const response = await fetch(
          "https://invoich-backend.onrender.com/api/salespersons/creatsalespersone",
          {
            method: "POST",
            headers: {
  ...
  const uploadCSV = async () => {
    ...
    try {
      const response = await fetch(
        "https://invoich-backend.onrender.com/api/salespersons/salespersonecsv",
        {
          method: "POST",
          body: formData,
        }
