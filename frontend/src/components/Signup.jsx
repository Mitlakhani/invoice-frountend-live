...
/>
 ...
 />
      ...
      <div className="hidden md:flex w-1/2 relative">
        <img src="/img/img.jpg" alt="Background" className="absolute w-full h-full object-cover" />
        ...
        <div className="absolute bottom-0 left-0 right-0 text-white text-center p-6">
          ...
          <p className="text-sm mt-2">Vestibulum auctor orci sit amet risus iaculis consequat. Sed tempus in elementum augue.</p>
        </div>
      </div>
    </div>
    </div>
