  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://invoich-backend.onrender.com/api/user/userlogin",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 max-w-full">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-[1920px] mx-auto h-screen bg-white shadow-lg rounded-lg overflow-hidden">
        {/* Left Section */}
        <div className="w-full md:w-1/2 px-4 sm:px-6 flex flex-col justify-center h-full relative">
          {/* Logo */}
          <img
            src="/img/logo.png"
            alt="Logo"
          ...
          <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6 max-w-2xl lg:mx-20 mt-16 md:mt-0">
